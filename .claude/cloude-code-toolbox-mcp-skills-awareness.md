...
_Generated: 2026-07-07T09:16:23.234Z_
...
Workspace `mcp.json` _(folder: VidiewCheclist)_

- **c:\Users\Amir OMEN\Desktop\Desktop2\VidiewCheclist\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Amir OMEN\.claude.json** — _File exists — no servers defined_
